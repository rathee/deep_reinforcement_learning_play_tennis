...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed, memory = None, train = True,
                 actor_filepath = None, critic_filepath = None):
        ...
        if actor_filepath and critic_filepath:
            actor_weights = torch.load(actor_filepath)
            critic_weights = torch.load(critic_filepath)
